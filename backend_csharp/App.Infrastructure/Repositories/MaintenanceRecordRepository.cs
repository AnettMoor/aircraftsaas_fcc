...
public class MaintenanceRecordRepository : BaseRepository<MaintenanceRecord, MaintenanceRecord, AppDbContext>, IMaintenanceRecordRepository
{
    public MaintenanceRecordRepository(AppDbContext dbContext, IBaseMapper<MaintenanceRecord, MaintenanceRecord> mapper)
