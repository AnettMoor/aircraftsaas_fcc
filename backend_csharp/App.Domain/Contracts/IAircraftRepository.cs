...
public interface IAircraftRepository : IBaseRepository<Aircraft>
{
    ...
    Task<Dictionary<Guid, int>> GetAircraftCountsByAirportAsync();
    Task<bool> HasActiveAtAirportAsync(Guid airportId);
    Task<IEnumerable<Aircraft>> GetAllSystemWideWithIncludesAsync();
}
