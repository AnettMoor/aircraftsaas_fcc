...
internal sealed class CompanyService : ICompanyService
{
    ...
    public CompanyService(IUsersUOW uow, IFleetModuleApi fleetApi)
    {
        _uow = uow;
        _fleetApi = fleetApi;
    }
    ...
    private async Task<CompanyDto> MapToDtoAsync(Company company)
    {
        ...
        // Cross-module: get aircraft count via Fleet API
        var aircraft = await _fleetApi.GetAircraftsByCompanyAsync(company.Id);
        var aircraftCount = aircraft.Count;
