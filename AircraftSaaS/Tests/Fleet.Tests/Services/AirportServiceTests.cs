...
public class AirportServiceTests
{
    ...
    public AirportServiceTests()
    {
        ...
        _sut = new AirportService(_uowMock.Object);
    }
    ...
    public async Task CreateAirportAsync_ValidDto_UppercasesCodesAndPersists()
    {
        ...
        // Act
        var result = await _sut.CreateAirportAsync(dto, "test-user");
    ...
    public async Task GetAirportByIdAsync_ExistingAirport_ReturnsDto()
    {
        ...
        _airportRepoMock.Setup(r => r.FindAsync(id, It.IsAny<Guid>(), It.IsAny<Guid?>())).ReturnsAsync(airport);
    ...
    public async Task GetAirportByIdAsync_NonExistingAirport_ReturnsNull()
    {
        // Arrange
        var id = Guid.NewGuid();
        _airportRepoMock.Setup(r => r.FindAsync(id, It.IsAny<Guid>(), It.IsAny<Guid?>())).ReturnsAsync((Airport?)null);
    ...
    public async Task UpdateAirportAsync_NotFound_ThrowsInvalidOperation()
    {
        ...
        // Act
        var act = () => _sut.UpdateAirportAsync(id, dto, "test-user");
    ...
    public async Task UpdateAirportAsync_ValidUpdate_UppercasesCodesAndSaves()
    {
        ...
        // Act
        var result = await _sut.UpdateAirportAsync(id, dto, "test-user");
    ...
    public async Task DeleteAirportAsync_ValidAirport_SoftDeletes()
    {
        ...
        // Act
        await _sut.DeleteAirportAsync(id, "test-user");
